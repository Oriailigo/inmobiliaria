...
function CardImg( { image }) {
  ...
  return (
    ...
    <Card sx={{ display: 'flex', gap: { xs: '0rem', sm: '2rem' }, flexDirection: { xs: 'column', sm: 'row' }, width: '100%', marginBottom: '20px' }}>
      ...
      <CardMedia
        component="img"
        sx={{ width: { xs: '100%', sm: '50%' }, height: { xs: '200px', sm: '400px' },cursor: 'pointer',  }}  // Ajustes responsivos
        image={ image }
        alt="Imagen"
        onClick={handleClick}
      />
      ...
      <CardContent sx={{ width: { xs: '100%', sm: '50%' }, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            ...
            Av. de los lagos 6785, Tigre, Buenos Aires.
            </Typography>
            ...
            {/* Fila 4: Párrafos */}
            <Typography variant="body2" sx={{fontWeight: 'bold'  }}>Venta Casa 3 ambientes amplio</Typography>
